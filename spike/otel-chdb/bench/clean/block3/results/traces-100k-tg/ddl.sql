CREATE TABLE mrg_traces_100k_tg.otel_traces (
...
SETTINGS index_granularity = 8192, ttl_only_drop_parts = 1, non_replicated_deduplication_window = 1000, old_parts_lifetime = 30;
