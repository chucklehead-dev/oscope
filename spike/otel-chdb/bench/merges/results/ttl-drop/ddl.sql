CREATE TABLE mrg_ttl_drop.otel_metrics_number_points
(
...
TTL toStartOfInterval(received_at,toIntervalMinute(4)) + toIntervalMinute(4)
SETTINGS non_replicated_deduplication_window = 1000, index_granularity = 8192, old_parts_lifetime = 30, ttl_only_drop_parts = 1, merge_with_ttl_timeout = 40;
