CREATE TABLE mrg_ttl_move_local.otel_traces (
...
TTL toStartOfInterval(received_at,toIntervalMinute(4)) + toIntervalMinute(4) TO VOLUME 'cold'
SETTINGS index_granularity = 8192, ttl_only_drop_parts = 1, non_replicated_deduplication_window = 1000, old_parts_lifetime = 30, storage_policy = 'tiered_local', merge_with_ttl_timeout = 40;
