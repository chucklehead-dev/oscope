CREATE TABLE mrg_ttl_move_s3.otel_traces (
...
SETTINGS index_granularity = 8192, ttl_only_drop_parts = 1, non_replicated_deduplication_window = 1000, old_parts_lifetime = 30, storage_policy = 'tiered_s3', merge_with_ttl_timeout = 40;
