...
(defn- render-grammar-reference []
  (str "<details class=\"grammar-reference\" open><summary>Chart grammar reference &amp; examples</summary>"
       ...
       "The editable chart contains signal, window, an optional fixed bucket, grouping, filters, aggregate series, and limit—not returned samples. "
       "Buckets are <code>:none</code>, <code>:1m</code>, <code>:5m</code>, <code>:15m</code>, or <code>:1h</code>; a fixed bucket produces <code>:bucket-start-unix-nano</code>.</dd>"
